<nav class="mb-6 flex flex-wrap gap-2" aria-label="Transport operations">
    @foreach ([['Transporters','admin.transport.transporters.index','admin.transport.transporters.*'],['Vehicles','admin.transport.vehicles.index','admin.transport.vehicles.*'],['Trips','admin.transport.trips.index','admin.transport.trips.*'],['Live map','admin.transport.map','admin.transport.map'],['Devices','admin.transport.devices.index','admin.transport.devices.*'],['Telemetry','admin.transport.telemetry.index','admin.transport.telemetry.*'],['Alerts','admin.transport.alerts.index','admin.transport.alerts.*'],['Sync health','admin.transport.sync.index','admin.transport.sync.*']] as [$label,$route,$pattern])
